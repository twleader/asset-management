...
public class PublicTradingCalendarExceptionAdvice {
    ...
    public ResponseEntity<ProblemDetail> invalid(PublicTradingCalendarRequestException ignored) {
    ...
    public ResponseEntity<ProblemDetail> timeout(PublicTradingCalendarTimeoutException ignored) {
    ...
    public ResponseEntity<ProblemDetail> invalidPayload(PublicTradingCalendarPayloadException ignored) {
