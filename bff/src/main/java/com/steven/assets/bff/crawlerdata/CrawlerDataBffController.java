...
/**
 * CrawlerDataView 專屬 BFF（「公開資訊」分組，Requirement 38 / Task 192、209）：
...
public class CrawlerDataBffController {
    ...
    /**
     * 讀 NewsPoller 公開資訊 JSON 輸出路徑設定（Task 209）：{@code {crawlerKey,outputSubpath,baseDir,absolutePath,updatedAt}}。
     *
