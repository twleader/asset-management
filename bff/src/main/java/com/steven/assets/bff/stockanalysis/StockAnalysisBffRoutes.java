 ...
 *
 * {@code /etf-holdings} 原本也是本檔的一條純轉發 route，Task 359.4 改為 BFF 端排序＋截斷
 * 「前 10 大 + 其它」後，已改由 {@link StockAnalysisChartBffController} 的真實 controller
 * method 提供，該路徑不再出現在下方 route 表裡（避免同一路徑同時被兩份定義）。
 */
@Configuration
