 ...
 */
public record PricePointDto(String tradingDate, BigDecimal openPrice, BigDecimal highPrice,
                            BigDecimal lowPrice, BigDecimal closePrice) {
    public PricePointDto(String tradingDate, BigDecimal closePrice) {
        this(tradingDate, null, null, null, closePrice);
    }
}
