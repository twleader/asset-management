...
public class PublicTransactionHistoryExceptionAdvice {
    ...
    public ResponseEntity<ProblemDetail> invalid(PublicTransactionHistoryRequestException ignored, ServerWebExchange exchange) {
    ...
    public ResponseEntity<ProblemDetail> invalidEmail(PublicTransactionHistoryEmailRequestException ignored, ServerWebExchange exchange) {
        capture(exchange, ignored);
    ...
    public ResponseEntity<ProblemDetail> unavailable(PublicTransactionHistoryUnavailableException ignored, ServerWebExchange exchange) {
        capture(exchange, ignored);
    ...
    public ResponseEntity<ProblemDetail> timeout(PublicTransactionHistoryTimeoutException ignored, ServerWebExchange exchange) {
        capture(exchange, ignored);
    ...
    public ResponseEntity<ProblemDetail> invalidPayload(PublicTransactionHistoryPayloadException ignored, ServerWebExchange exchange) {
        capture(exchange, ignored);
