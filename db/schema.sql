...
--
-- 產生資訊：PostgreSQL 16.14 / pg_dump 16.14，來源 asset-postgres schema-only dump，2026-09-25
-- 產生當下表數：106 張 CREATE TABLE（對照：SELECT count(*) FROM pg_tables WHERE schemaname='public';）
--
--
--
...
--
-- Name: reject_srpp_immutable_update(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.reject_srpp_immutable_update() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: srpp_context_evidence; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.srpp_context_evidence (
...
--
-- Name: srpp_context_package; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.srpp_context_package (
    package_id uuid NOT NULL,
    owner_user_id bigint NOT NULL,
    trading_date date NOT NULL,
...
CREATE TABLE public.srpp_owner_key (
    owner_user_id bigint NOT NULL,
...
--
-- Name: srpp_policy_registry; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.srpp_policy_registry (
    policy_bundle_sha256 character(64) NOT NULL,
    formula_version character varying(64) NOT NULL,
    policy_document text NOT NULL,
    formula_manifest text NOT NULL,
    registered_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT srpp_policy_registry_policy_bundle_sha256_check CHECK (((policy_bundle_sha256 ~ '^[0-9a-f]{64}$'::text) AND ((policy_bundle_sha256)::text <> repeat('0'::text, 64))))
);
...
--
-- Name: srpp_context_evidence srpp_context_evidence_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.srpp_context_evidence
    ADD CONSTRAINT srpp_context_evidence_pkey PRIMARY KEY (package_id, source_id);


--
-- Name: srpp_context_package srpp_context_package_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.srpp_context_package
    ADD CONSTRAINT srpp_context_package_pkey PRIMARY KEY (package_id);
...
ALTER TABLE ONLY public.srpp_owner_key
    ADD CONSTRAINT srpp_owner_key_owner_key_key UNIQUE (owner_key);


--
-- Name: srpp_owner_key srpp_owner_key_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.srpp_owner_key
    ADD CONSTRAINT srpp_owner_key_pkey PRIMARY KEY (owner_user_id);


--
-- Name: srpp_policy_registry srpp_policy_registry_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.srpp_policy_registry
    ADD CONSTRAINT srpp_policy_registry_pkey PRIMARY KEY (policy_bundle_sha256);
...
--
-- Name: idx_srpp_context_package_latest; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_srpp_context_package_latest ON public.srpp_context_package USING btree (owner_user_id, trading_date, slot, policy_bundle_sha256, generated_at DESC, package_id DESC);


--
-- Name: idx_srpp_context_package_trading_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: srpp_context_evidence trg_srpp_context_evidence_no_update; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_srpp_context_evidence_no_update BEFORE UPDATE ON public.srpp_context_evidence FOR EACH ROW EXECUTE FUNCTION public.reject_srpp_immutable_update();


--
-- Name: srpp_context_package trg_srpp_context_package_no_update; Type: TRIGGER; Schema: public; Owner: -
--
...
CREATE TRIGGER trg_srpp_owner_key_no_update BEFORE UPDATE ON public.srpp_owner_key FOR EACH ROW EXECUTE FUNCTION public.reject_srpp_immutable_update();


--
-- Name: srpp_policy_registry trg_srpp_policy_registry_no_update; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_srpp_policy_registry_no_update BEFORE UPDATE ON public.srpp_policy_registry FOR EACH ROW EXECUTE FUNCTION public.reject_srpp_immutable_update();
...
--
-- Name: srpp_context_evidence srpp_context_evidence_package_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.srpp_context_evidence
    ADD CONSTRAINT srpp_context_evidence_package_id_fkey FOREIGN KEY (package_id) REFERENCES public.srpp_context_package(package_id) ON DELETE CASCADE;


--
-- Name: srpp_context_package srpp_context_package_owner_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.srpp_context_package
    ADD CONSTRAINT srpp_context_package_owner_user_id_fkey FOREIGN KEY (owner_user_id) REFERENCES public.app_user(id);


--
-- Name: srpp_context_package srpp_context_package_policy_bundle_sha256_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: srpp_owner_key srpp_owner_key_owner_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.srpp_owner_key
    ADD CONSTRAINT srpp_owner_key_owner_user_id_fkey FOREIGN KEY (owner_user_id) REFERENCES public.app_user(id);
