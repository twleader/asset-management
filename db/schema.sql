...
-- 產生當下表數：87 張 CREATE TABLE（對照：SELECT count(*) FROM pg_tables WHERE schemaname='public';）
--
--
--
...
CREATE TABLE public.blog_publish_credential (
    ...
    blog_url character varying(512) DEFAULT 'https://twleader.blogspot.com/'::character varying NOT NULL,
