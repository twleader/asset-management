 ...
 *  - DELETE /api/watch-stocks/{code}/{market}   刪除該股票所有 alert（連帶 trigger 歷史）
...
public class WatchStockController {
    ...
    @DeleteMapping("/{stockCode}/{market}")
    public ResponseEntity<Void> delete(@PathVariable String stockCode, @PathVariable String market) {
        service.delete(stockCode, market);
