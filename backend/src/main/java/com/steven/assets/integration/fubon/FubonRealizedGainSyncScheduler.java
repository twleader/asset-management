...
@Component
public class FubonRealizedGainSyncScheduler {
    private final FubonRealizedGainSyncService syncService;
    private final AtomicBoolean inFlight = new AtomicBoolean();

    @Autowired
    public FubonRealizedGainSyncScheduler(FubonRealizedGainSyncService syncService) {
    ...
    public void scheduledRealizedGainSync() {
