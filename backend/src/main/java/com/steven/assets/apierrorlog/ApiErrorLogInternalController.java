...
public class ApiErrorLogInternalController {
    private static final Set<String> FIELDS = Set.of("source","operationKey","apiName","messageHeader","stackTrace","occurredAt");
    ...
    public void ingest(@RequestHeader HttpHeaders headers, @RequestBody JsonNode body) {
        ...
        try {
            ...
            recorder.record(source,key,name,header,trace,Instant.parse(text(body,"occurredAt")));
