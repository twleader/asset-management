...
```
spec/
├── requirements.md       # 88 個 Requirements（User Story + AC；Requirement 86 由在途 worktree 保留，最新為 89）
├── design.md             # 架構圖、ERD、Service 職責、Sequence
├── tasks.md              # 任務索引（Task 1–228、264–267、269–292、297–309、311–342、344–346、348–350）＋ 尚未歸檔的 201 起區段
├── tasks/                # 任務檔
│   ├── README.md         # 自足任務檔規範
