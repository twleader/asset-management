...
| 341 | 交易雷達美股大盤接上量價環境因子，跨市場改為「不適用」語意，`RULE_VERSION` 升 `TW_RULES_V14`（Requirement 82；規劃階段原為 339／R80，因與其他尚未落地的 worktree 撞號主動避讓） | [tasks/t341_radar_us_market_volume_regime_wiring.md](tasks/t341_radar_us_market_volume_regime_wiring.md) |
