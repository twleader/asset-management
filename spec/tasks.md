...
## 任務索引（Task 1–228、264–267、269–282、285–286）
...
> **註：本索引表列至 228、264–267、269–282、285–286；Task 283／284 於 `origin/main` 已存在
> （交易雷達頁首匯出雙格式／交易雷達收合列補顯示 MA5），本分支尚未 merge 帶入，故本表暫缺該兩列，
> merge 後由 main 帶入補回；Task 229–263 與 268 未登錄於本表，以 `spec/tasks/tNNN_*.md` 檔案本身為準。**
