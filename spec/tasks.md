...
| 280 | 交易雷達匯出補上週線 MA5 與走勢圖指標選單的 14 個值（大盤總覽 20→35 欄、個股決策 35→50 欄；Requirement 43／48） | [tasks/t280_radar_export_indicators.md](tasks/t280_radar_export_indicators.md) |
