...
| `spec/tasks.md` | 任務索引（Task 1–228、264–267、269–282、285–286；**283／284 在 origin/main 已存在**〔`t283_radar_manual_export_dual_format.md`／`t284_trading_radar_ma5_summary.md`〕**但本分支尚未 merge 帶入，故此處列表暫無該兩列，merge 後補回**）＋ 尚未歸檔的 Task 201 起區段；Task 229–263 與 268 未登錄於本表，以 `spec/tasks/tNNN_*.md` 檔案本身為準 |
