...
| 文件 | 說明 |
|------|------|
| `spec/requirements.md` | User Stories + Acceptance Criteria（159 個 Requirements；最新編號為 166，136–140 間為並行 worktree 保留跳號） |
