...
| 文件 | 說明 |
|------|------|
| `spec/requirements.md` | User Stories + Acceptance Criteria（60 個 Requirements） |
| `spec/design.md` | 架構圖、ERD、API 端點、關鍵業務邏輯 |
| `spec/tasks.md` | 任務索引（Task 1–228、264–267、273–278）＋ 尚未歸檔的 Task 201 起區段；Task 229–263、268–272 未登錄於本表，以 `spec/tasks/tNNN_*.md` 檔案本身為準 |
