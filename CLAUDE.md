...
| `spec/tasks.md` | 任務索引（Task 1–228、264–267、269–292、297–309、311–342、344–347、349–350）＋尚未歸檔的 Task 201 起區段；Task 229–263、268、293–296 以各自 `spec/tasks/tNNN_*.md` 為準；Task 348 由在途 worktree 保留，main 的 Task 351（交易日曆）與 Fubon Task 352–353 以各自任務檔為準 |
