...
| 文件 | 說明 |
|------|------|
| `spec/requirements.md` | User Stories + Acceptance Criteria（132 個 Requirements；最新編號為 140，136–140 間為並行 worktree 保留跳號） |
| `spec/design.md` | 架構圖、ERD、API 端點、關鍵業務邏輯 |
| `spec/tasks.md` | 任務索引（Task 1–228、264–267、269–292、297–309、311–342、344–390、393–398、416）＋尚未歸檔的 Task 201 起區段；Task 229–263、268、293–296、416 以各自 `spec/tasks/tNNN_*.md` 為準 |
